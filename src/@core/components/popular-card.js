...
const PopularCard = props => {
  ...
  return (
    <Box sx={styles.popularCard} className={`${status === true ? 'active' : ''}`}>
        ...
        <Box sx={styles.popularCard.top}>
          <Box sx={styles.popularCard.content}>
            <Box sx={styles.popularCard.meta}>
              <Box sx={styles.popularCard.stars} className={`starCount-${props.starCount}`}>
                <FaStar />
                <FaStar />
                <FaStar />
                <FaStar />
              ...
              <Box sx={styles.popularCard.watch}>
                <Image src={'eye-2'} alt='' /> {props.watchCount}
              </Box>
            </Box>
            <Heading as='h3'>
          ...
          <Box sx={styles.popularCard.buttonBox}>
            <Button sx={styles.popularCard.courseBtn} onClick={handleClick} varient='buttons.primary'>
              7 Video Classes
