          ...
          <Box sx={styles.ctaThree.colTwo}>
            <Box className='my-auto'>
              <Box sx={styles.ctaThree.content}>
                ...
                <Link path='#' label='Explore details' variant='buttons.primary' />
              </Box>
            </Box>
          </Box>
          <Box sx={styles.ctaThree.colOne}>
            <Grid sx={styles.ctaThree.grid}>
              ...
              <Box sx={styles.ctaThree.box}>
                ...
                <Text as='p'>{'Free online tutorials \n videos avaialble'}</Text>
              </Box>
              <Box sx={styles.ctaThree.box}>
              ...
              <Box sx={styles.ctaThree.box}>
                ...
                <Text as='p'>{'Job posted everydays \n with  qualification'}</Text>
              </Box>
            </Grid>
          </Box>
        </Flex>
